        ...
        with self.executed_actions_lock:
            for action in incoming_actions:
                ...
                if timestep in self.executed_actions:
                    ...
                    if timestep+100 in self.executed_actions.keys():
                        delta_action = self.executed_actions[timestep + 100].get_action()
                        print(f"delta action: {delta_action}")
                        print(f"old action: {executed_action - delta_action}")
